...
// --- 方案 B 量測用計數器（非 static，供 ctypes 讀取）---
long long g_evaluateCalls = 0;
long long g_miniMaxCalls = 0;
clock_t g_evaluateTicks = 0;
...
double getEvaluateSeconds() {
    return (double)g_evaluateTicks / CLOCKS_PER_SEC;
}
